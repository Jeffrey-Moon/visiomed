		...
		<section id="main" class="container" style="text-align: center; ">
			<header>
				...
				<i class="fa-solid fa-capsules"></i>
					<!-- 실사용자 이름 출력 (수정 필요)-->
					<strong><%=name %></strong>님의 약 보관함 페이지입니다. 여기서 약 정보를 등록, 수정, 그리고 삭제할 수 있습니다.
				</h4>
				<span></span>
			</header>
				...
				<div>
					<div class="row-6 row-12-mobilep">
						<table style="">
							<thead>
			                     <tr>
			                        <td colspan="7vw" align="center">
			                        <i class="fa-solid fa-check"></i> &nbsp;&nbsp;함에 맞는 사용자의 약 이름를 등록해 주세요 (예: 타이레놀, 후시딘).<br>
			                        <i class="fa-solid fa-check"></i> &nbsp;&nbsp;처방의료기관(병원명, 약국명)을 입력해 주세요 (예: 서울xx병원).<br>
			                        <i class="fa-solid fa-check"></i> &nbsp;&nbsp;용법에 약의 사용법이나 사용주기 및 제한 등의 간단한 설명을 입력해 주세요. <br>
			                        <i class="fa-solid fa-check"></i> &nbsp;&nbsp;약의 처방일자를 선택 후 복용시간 알람을 맞춰 주세요. </td>
			                     </tr>
		        ...
		        success : function(res) {
		        	if(res.length !== 0){
			            ...
			            for (let i = 0; i < res.length; i++) {
							...
							table = '<tr id="'+(i+1)+'">';
							table +='<td align="center" >'+res[i].med_box+'</td>'
